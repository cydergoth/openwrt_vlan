...
* [Firewall config](configs/gateway/etc/firewall)
...
![Switch config luci](images/netgear-luci-switch.png) 

[Switch config](configs/netgear/etc/config/network)
